...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " produto"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " produto"; } ?></div>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_line" id="hidden_field_data_id" style="<?php echo $sStyleHidden_id; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_label"><span id="id_label_id"><?php echo $this->nm_new_label['id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['php_cmp_required']['id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['php_cmp_required']['id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<span id="id_read_on_nome" class="sc-ui-readonly-nome css_nome_line" style="<?php echo $sStyleReadLab_nome; ?>"><?php echo $this->form_encode_input($this->nome); ?></span><span id="id_read_off_nome" style="white-space: nowrap;<?php echo $sStyleReadInp_nome; ?>">
 ...
 size=80 maxlength=200 alt="{datatype: 'text', maxLength: 200, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<span id="id_read_on_altura" class="sc-ui-readonly-altura css_altura_line" style="<?php echo $sStyleReadLab_altura; ?>"><?php echo $this->form_encode_input($this->altura); ?></span><span id="id_read_off_altura" style="white-space: nowrap;<?php echo $sStyleReadInp_altura; ?>">
 ...
 size=10 alt="{datatype: 'decimal', maxLength: 10, precision: 4, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['altura']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['altura']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['altura']['symbol_fmt']; ?>, manualDecimals: true, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['altura']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
?>
<tr><td class="scFormPopupTopRight scFormPopupCorner"></td><td class="scFormPopupTop"></td><td class="scFormPopupTopLeft scFormPopupCorner"></td></tr><tr><td class="scFormPopupRight"></td><td class="scFormPopupContent">medida em centímetros</td><td class="scFormPopupLeft"></td></tr><tr><td class="scFormPopupBottomRight scFormPopupCorner"></td><td class="scFormPopupBottom"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Ini->Bubble_tail; ?>" /></td><td class="scFormPopupBottomLeft scFormPopupCorner"></td></tr><?php
} else {
?>
<tr><td class="scFormPopupTopLeft scFormPopupCorner"></td><td class="scFormPopupTop"></td><td class="scFormPopupTopRight scFormPopupCorner"></td></tr><tr><td class="scFormPopupLeft"></td><td class="scFormPopupContent">medida em centímetros</td><td class="scFormPopupRight"></td></tr><tr><td class="scFormPopupBottomLeft scFormPopupCorner"></td><td class="scFormPopupBottom"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Ini->Bubble_tail; ?>" /></td><td class="scFormPopupBottomRight scFormPopupCorner"></td></tr><?php
}
?>
</tbody></table></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_altura_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_altura_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['largura']))
    {
        $this->nm_new_label['largura'] = "Largura";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $sStyleHidden_largura = '';
   if (isset($this->nmgp_cmp_hidden['largura']) && $this->nmgp_cmp_hidden['largura'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['largura']);
       $sStyleHidden_largura = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_largura = 'display: none;';
   $sStyleReadInp_largura = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['largura']) && $this->nmgp_cmp_readonly['largura'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['largura']);
       $sStyleReadLab_largura = '';
       $sStyleReadInp_largura = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['largura']) && $this->nmgp_cmp_hidden['largura'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="largura" value="<?php echo $this->form_encode_input($largura) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_largura_line" id="hidden_field_data_largura" style="<?php echo $sStyleHidden_largura; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_largura_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_largura_label"><span id="id_label_largura"><?php echo $this->nm_new_label['largura']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["largura"]) &&  $this->nmgp_cmp_readonly["largura"] == "on") { 

 ?>
<input type="hidden" name="largura" value="<?php echo $this->form_encode_input($largura) . "\">" . $largura . ""; ?>
<?php } else { ?>
<span id="id_read_on_largura" class="sc-ui-readonly-largura css_largura_line" style="<?php echo $sStyleReadLab_largura; ?>"><?php echo $this->form_encode_input($this->largura); ?></span><span id="id_read_off_largura" style="white-space: nowrap;<?php echo $sStyleReadInp_largura; ?>">
 <input class="sc-js-input scFormObjectOdd css_largura_obj" style="" id="id_sc_field_largura" type=text name="largura" value="<?php echo $this->form_encode_input($largura) ?>"
 size=10 alt="{datatype: 'decimal', maxLength: 10, precision: 4, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['largura']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['largura']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['largura']['symbol_fmt']; ?>, manualDecimals: true, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['largura']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
<span class="scFormPopupBubble" style="vertical-align: top; display: inline-block"><span class="scFormPopupTrigger"><?php echo nmButtonOutput($this->arr_buttons, "bfieldhelp", "return false;", "return false;", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
</span><table class="scFormPopup"><tbody><?php
if (isset($_SESSION['scriptcase']['reg_conf']['html_dir']) && $_SESSION['scriptcase']['reg_conf']['html_dir'] == " DIR='RTL'") {
?>
...
?>
</tbody></table></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_largura_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_largura_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['profundidade']))
    {
        $this->nm_new_label['profundidade'] = "Profundidade";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $sStyleHidden_profundidade = '';
   if (isset($this->nmgp_cmp_hidden['profundidade']) && $this->nmgp_cmp_hidden['profundidade'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['profundidade']);
       $sStyleHidden_profundidade = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_profundidade = 'display: none;';
   $sStyleReadInp_profundidade = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['profundidade']) && $this->nmgp_cmp_readonly['profundidade'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['profundidade']);
       $sStyleReadLab_profundidade = '';
       $sStyleReadInp_profundidade = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['profundidade']) && $this->nmgp_cmp_hidden['profundidade'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="profundidade" value="<?php echo $this->form_encode_input($profundidade) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_profundidade_line" id="hidden_field_data_profundidade" style="<?php echo $sStyleHidden_profundidade; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_profundidade_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_profundidade_label"><span id="id_label_profundidade"><?php echo $this->nm_new_label['profundidade']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["profundidade"]) &&  $this->nmgp_cmp_readonly["profundidade"] == "on") { 

 ?>
<input type="hidden" name="profundidade" value="<?php echo $this->form_encode_input($profundidade) . "\">" . $profundidade . ""; ?>
<?php } else { ?>
<span id="id_read_on_profundidade" class="sc-ui-readonly-profundidade css_profundidade_line" style="<?php echo $sStyleReadLab_profundidade; ?>"><?php echo $this->form_encode_input($this->profundidade); ?></span><span id="id_read_off_profundidade" style="white-space: nowrap;<?php echo $sStyleReadInp_profundidade; ?>">
 <input class="sc-js-input scFormObjectOdd css_profundidade_obj" style="" id="id_sc_field_profundidade" type=text name="profundidade" value="<?php echo $this->form_encode_input($profundidade) ?>"
 size=10 alt="{datatype: 'decimal', maxLength: 10, precision: 4, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['profundidade']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['profundidade']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['profundidade']['symbol_fmt']; ?>, manualDecimals: true, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['profundidade']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
<span class="scFormPopupBubble" style="vertical-align: top; display: inline-block"><span class="scFormPopupTrigger"><?php echo nmButtonOutput($this->arr_buttons, "bfieldhelp", "return false;", "return false;", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
</span><table class="scFormPopup"><tbody><?php
if (isset($_SESSION['scriptcase']['reg_conf']['html_dir']) && $_SESSION['scriptcase']['reg_conf']['html_dir'] == " DIR='RTL'") {
?>
...
?>
</tbody></table></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_profundidade_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_profundidade_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['comentario'] = "Comentário";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_comentario_line" id="hidden_field_data_comentario" style="<?php echo $sStyleHidden_comentario; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_comentario_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_comentario_label"><span id="id_label_comentario"><?php echo $this->nm_new_label['comentario']; ?></span></span><br><span id="id_read_on_comentario" style="<?php echo $sStyleReadLab_comentario; ?>"><?php echo sc_strip_script($this->comentario); ?></span><span id="id_read_off_comentario" style="<?php echo $sStyleReadInp_comentario; ?>"><textarea id="comentario" name="comentario" cols="50" rows="10" class="mceEditor_comentario" style="width: 100%; height:200px;"><?php echo $this->form_encode_input($this->comentario); ?></textarea>
</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_comentario_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_comentario_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
