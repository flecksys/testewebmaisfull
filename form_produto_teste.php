<?php  
  ...
  session_start() ;
  class form_produto_form_teste
  {
   function form_produto_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_produto/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_produto</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_produto"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_produto_form_teste();
  $frm_teste->form_produto_teste();
?>
