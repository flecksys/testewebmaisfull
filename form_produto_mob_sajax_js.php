...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id
  function do_ajax_form_produto_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_id(var_id, var_script_case_init, do_ajax_form_produto_mob_validate_id_cb);
  } // do_ajax_form_produto_mob_validate_id

  function do_ajax_form_produto_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_id_cb

  // ---------- Validate nome
  function do_ajax_form_produto_mob_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_nome(var_nome, var_script_case_init, do_ajax_form_produto_mob_validate_nome_cb);
  } // do_ajax_form_produto_mob_validate_nome

  function do_ajax_form_produto_mob_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nome";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_nome_cb

  // ---------- Validate altura
  function do_ajax_form_produto_mob_validate_altura()
  {
    var nomeCampo_altura = "altura";
    var var_altura = scAjaxGetFieldText(nomeCampo_altura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_altura(var_altura, var_script_case_init, do_ajax_form_produto_mob_validate_altura_cb);
  } // do_ajax_form_produto_mob_validate_altura

  function do_ajax_form_produto_mob_validate_altura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "altura";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_altura_cb

  // ---------- Validate largura
  function do_ajax_form_produto_mob_validate_largura()
  {
    var nomeCampo_largura = "largura";
    var var_largura = scAjaxGetFieldText(nomeCampo_largura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_largura(var_largura, var_script_case_init, do_ajax_form_produto_mob_validate_largura_cb);
  } // do_ajax_form_produto_mob_validate_largura

  function do_ajax_form_produto_mob_validate_largura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "largura";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_largura_cb

  // ---------- Validate profundidade
  function do_ajax_form_produto_mob_validate_profundidade()
  {
    var nomeCampo_profundidade = "profundidade";
    var var_profundidade = scAjaxGetFieldText(nomeCampo_profundidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_profundidade(var_profundidade, var_script_case_init, do_ajax_form_produto_mob_validate_profundidade_cb);
  } // do_ajax_form_produto_mob_validate_profundidade

  function do_ajax_form_produto_mob_validate_profundidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_profundidade_cb

  // ---------- Validate comentario
  function do_ajax_form_produto_mob_validate_comentario()
  {
    var nomeCampo_comentario = "comentario";
    var var_comentario = scAjaxGetFieldEditorHtml(nomeCampo_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_comentario(var_comentario, var_script_case_init, do_ajax_form_produto_mob_validate_comentario_cb);
  } // do_ajax_form_produto_mob_validate_comentario

  function do_ajax_form_produto_mob_validate_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_comentario_cb
  // ---------- Form
  function do_ajax_form_produto_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_produto_mob_submit_form(var_id, var_nome, var_altura, var_largura, var_profundidade, var_comentario, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_produto_mob_submit_form_cb);
...
?>
  ...
  function do_ajax_form_produto_mob_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_produto_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_produto_mob_navigate_form_cb);
