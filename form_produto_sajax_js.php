...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id
  function do_ajax_form_produto_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_validate_id(var_id, var_script_case_init, do_ajax_form_produto_validate_id_cb);
  } // do_ajax_form_produto_validate_id

  function do_ajax_form_produto_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_validate_id_cb

  // ---------- Validate nome
  function do_ajax_form_produto_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_validate_nome(var_nome, var_script_case_init, do_ajax_form_produto_validate_nome_cb);
  } // do_ajax_form_produto_validate_nome

  function do_ajax_form_produto_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nome";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_validate_nome_cb

  // ---------- Validate altura
  function do_ajax_form_produto_validate_altura()
  {
    var nomeCampo_altura = "altura";
    var var_altura = scAjaxGetFieldText(nomeCampo_altura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_validate_altura(var_altura, var_script_case_init, do_ajax_form_produto_validate_altura_cb);
  } // do_ajax_form_produto_validate_altura

  function do_ajax_form_produto_validate_altura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "altura";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_validate_altura_cb

  // ---------- Validate largura
  function do_ajax_form_produto_validate_largura()
  {
    var nomeCampo_largura = "largura";
    var var_largura = scAjaxGetFieldText(nomeCampo_largura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_validate_largura(var_largura, var_script_case_init, do_ajax_form_produto_validate_largura_cb);
  } // do_ajax_form_produto_validate_largura

  function do_ajax_form_produto_validate_largura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "largura";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_validate_largura_cb

  // ---------- Validate profundidade
  function do_ajax_form_produto_validate_profundidade()
  {
    var nomeCampo_profundidade = "profundidade";
    var var_profundidade = scAjaxGetFieldText(nomeCampo_profundidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_validate_profundidade(var_profundidade, var_script_case_init, do_ajax_form_produto_validate_profundidade_cb);
  } // do_ajax_form_produto_validate_profundidade

  function do_ajax_form_produto_validate_profundidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "profundidade";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_validate_profundidade_cb

  // ---------- Validate comentario
  function do_ajax_form_produto_validate_comentario()
  {
    var nomeCampo_comentario = "comentario";
    var var_comentario = scAjaxGetFieldEditorHtml(nomeCampo_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_validate_comentario(var_comentario, var_script_case_init, do_ajax_form_produto_validate_comentario_cb);
  } // do_ajax_form_produto_validate_comentario

  function do_ajax_form_produto_validate_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_validate_comentario_cb
  // ---------- Form
  function do_ajax_form_produto_submit_form()
  {
    ...
    var var_largura = scAjaxGetFieldText("largura");
    var var_profundidade = scAjaxGetFieldText("profundidade");
    var var_comentario = scAjaxGetFieldEditorHtml("comentario");
    ...
    scAjaxProcOn();
    x_ajax_form_produto_submit_form(var_id, var_nome, var_altura, var_largura, var_profundidade, var_comentario, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_produto_submit_form_cb);
  ...
  function do_ajax_form_produto_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("largura");
      scAjaxHideErrorDisplay("profundidade");
...
?>
  ...
  function do_ajax_form_produto_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_produto_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_produto_navigate_form_cb);
...
?>
  ...
  ajax_field_list[2] = "altura";
  ajax_field_list[3] = "largura";
  ajax_field_list[4] = "profundidade";
  ajax_field_list[5] = "comentario";
  ...
  var ajax_error_list = {
    ...
    "largura": {"label": "Largura", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "profundidade": {"label": "Profundidade", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "comentario": {"label": "Comentário", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_id = {
    ...
    "largura": new Array("hidden_field_label_largura", "hidden_field_data_largura"),
    "profundidade": new Array("hidden_field_label_profundidade", "hidden_field_data_profundidade"),
