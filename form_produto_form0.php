...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_label" id="hidden_field_label_id" style="<?php echo $sStyleHidden_id; ?>"><span id="id_label_id"><?php echo $this->nm_new_label['id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['php_cmp_required']['id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['php_cmp_required']['id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_largura_label" id="hidden_field_label_largura" style="<?php echo $sStyleHidden_largura; ?>"><span id="id_label_largura"><?php echo $this->nm_new_label['largura']; ?></span></TD>
    <TD class="scFormDataOdd css_largura_line" id="hidden_field_data_largura" style="<?php echo $sStyleHidden_largura; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_largura_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_profundidade_label" id="hidden_field_label_profundidade" style="<?php echo $sStyleHidden_profundidade; ?>"><span id="id_label_profundidade"><?php echo $this->nm_new_label['profundidade']; ?></span></TD>
    <TD class="scFormDataOdd css_profundidade_line" id="hidden_field_data_profundidade" style="<?php echo $sStyleHidden_profundidade; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_profundidade_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_comentario_line" id="hidden_field_data_comentario" style="<?php echo $sStyleHidden_comentario; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_comentario_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_comentario" style="<?php echo $sStyleReadLab_comentario; ?>"><?php echo sc_strip_script($this->comentario); ?></span><span id="id_read_off_comentario" style="<?php echo $sStyleReadInp_comentario; ?>"><textarea id="comentario" name="comentario" cols="50" rows="10" class="mceEditor_comentario" style="width: 100%; height:200px;"><?php echo $this->form_encode_input($this->comentario); ?></textarea>
